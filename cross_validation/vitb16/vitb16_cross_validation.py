...
def build_vit_b16(num_classes: int) -> Tuple[nn.Module, str]:
...
def run_one_fold(
    ...
    model, backend = build_vit_b16(num_classes)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(f"[Fold {fold_id+1}] Epoch {epoch}/{args.epochs}  (lr={current_lr:.6f})")
...
def parse_args():
    p = argparse.ArgumentParser(description="ViT-B/16 K-Fold Cross-Validation")
