...
def build_vit_b16(num_classes: int):
    ...
    in_features = tv_model.heads.head.in_features
    tv_model.heads.head = nn.Linear(in_features, num_classes)
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default="./outputs_vitb16_cap100_70_10_20")
    parser.add_argument("--epochs", type=int, default=30)
    parser.add_argument("--batch_size", type=int, default=32)
    parser.add_argument("--lr", type=float, default=1e-4)
    parser.add_argument("--weight_decay", type=float, default=1e-4)
    parser.add_argument("--warmup_epochs", type=int, default=5,
                        help="Number of linear warmup epochs for the LR scheduler")
    ...
    model, backend = build_vit_b16(num_classes=num_classes)
    ...
    # Warmup + Cosine Annealing schedule (ViT benefits from LR warmup)
    ...
    print(f"Start training ViT-B/16 on {device} | backend={backend}")
    best_val_acc = 0.0
